        ...
        set @sql  = '
            ...
            from (
                    ...
                    SELECT distinct
                        ...
                        ,command        = null
                        ,type           = case 
                                            when cast(OBJECTPROPERTYEX(com.id, ''BaseType'') as varchar(10)) = ''P'' 
                                                then ''Procedure body''
                                            when cast(OBJECTPROPERTYEX(com.id, ''BaseType'') as varchar(10)) = ''F'' 
                                                then ''Function body''
                                            when cast(OBJECTPROPERTYEX(com.id, ''BaseType'') as varchar(10)) = ''V'' 
                                                then ''View body''
                                            else ''Unknown body''
                                          end
